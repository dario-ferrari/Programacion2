...
public class Ejercicio5B {
    public static void main(String[] args) {
        ...
        DiccionarioMultipleTDA resultado = combinarClavesComunes(D1, D2);
        imprimirDiccionario(resultado);
    }

    public static DiccionarioMultipleTDA combinarClavesComunes(DiccionarioMultipleTDA D1, DiccionarioMultipleTDA D2) {
